<% if(session.getAttribute("name") == null )
	//{response.sendRedirect("paginas/login/login.jsp"); }
%>

<%-- 0 es por los segundos que vamos a esperar antes de hacer refresh --%>
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">WENDY eCOMERCE</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Productos</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">Acerca de Wendy eComerce</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Contactos</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="">Salir</a></li>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">BIENVENIDO A WENDY eCOMERCE</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - Biu</p>
		</div>
	</header>
	<!-- Portfolio Section-->
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Productos</h2>
			<!-- Icon Divider-->
	...
	<section class="page-section bg-primary text-white mb-0" id="about">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-white">Wendy eComerce</h2>
			<!-- Icon Divider-->
			<div class="divider-custom divider-light">
				<div class="divider-custom-line"></div>
				<div class="divider-custom-icon">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Esto es un proyecto de estudio, de la Maestria BIU.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Usted podrá registrarse en este sitio que sus datos estaran bien protegidos por leyes internaciones de confidelidad!
					todos los derechos reservados Ing. Wendy Reyes Rojas 809-330-1959</p>
				</div>
			</div>
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					...
					class="fas fa-download me-2"></i>Descarga Gratis!
				</a>
			</div>
		</div>
	</section>
	...
	<section class="page-section" id="contact">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Contactos
				Me</h2>
			<!-- Icon Divider-->
			<div class="divider-custom">
				<div class="divider-custom-line"></div>
					...
					<form id="contactForm" data-sb-form-api-token="API_TOKEN">
						...
						<div class="d-none" id="submitSuccessMessage">
							<div class="text-center mb-3">
								<div class="fw-bolder">Formulario Aceptado</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					<h4 class="text-uppercase mb-4">Ubicacióon</h4>
					<p class="lead mb-0">
						Calle Domingo Gelabert #17, Santisima Trinidad, Nagua, Republica Dominicana <br /> Codigo Postal, 35500
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
					<h4 class="text-uppercase mb-4">Entorno de la Web</h4>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Ing. Wendy Reyes Biu 2025</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
...
<!--  
<meta http-equiv="refresh" content="0;url=${pageContext.request.contextPath}/UsuarioControlador">
